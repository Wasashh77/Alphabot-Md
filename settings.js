...
// Other
// Other
global.botname = "NO4H-Md" //namabot kalian
global.ownername = "Noah" //nama kalian
global.myweb = "https://s.id/" //bebas asal jan hapus
global.youtube = "https://youtube.com/c/@was.ash.enough" //bebas asal jan hapus
global.myweb2 = "https://s.id" //bebas
global.email = "zeeoneofc@" //bebas
...
global.premium = ['923164413714'] //premium user
global.owner = ["923164413714", "923164413714"] //ganti agar fitur owner bisa di gunakan
...
global.mess = {
   ...
   admin: 'You need to be admin to use this nigga !',
   botAdmin: 'make the bot admin to continue  !',
   owner: 'only my owner can use this cmd !',
   group: 'you can only use this command in group !',
   private: 'This Command Can Only Be Used In Private !',
   bot: 'This Command Can Only Be Used In Private ',
   errtoimg: 'Sorry, currently we do not support GIF stickers',
   wait: '⏳ sending',
   lockCmd: 'Feature Not Enabled By Owner!',
   example1: 'Welcome @user to the @subject group. Welcome @user to the @subject group. Dont forget to read the rules @desc\n\nNote:\n1. @user (Mention User Join)\n2. @bio (Get Bio User Join)\n3. @date (Date Now)\n4. @desc (Get Description Group)\n5. forget to read the rules @desc\n\nNote:\n1. @user (Mention User Join)\n2. @bio (Get Bio User Join)\n3. @date (Date Now)\n4. @desc (Get Description Group)\n5.l'
}
